        ...
        try {
            ...
            Pair_Code_By_France_King.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const targetPath = './sessions/alone-md';

                    fs.cpSync(tempPath, targetPath, { recursive: true, force: true });

                    if (!notificationSent) {
                        const data = fs.readFileSync(`${tempPath}/creds.json`);
...
Repository available at our channel`;
                    ...
                    return await removeFile(tempPath);
                } else if (
                    connection === "close" &&
            ...
            console.log("Service error or restart:", err);
